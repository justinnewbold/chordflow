...
// Allowlist of origins permitted to call this API from a browser. We previously
// echoed `*` which let any third-party site mount our endpoints — and burn the
// Gemini quota or surface our auth endpoint for credential stuffing.
